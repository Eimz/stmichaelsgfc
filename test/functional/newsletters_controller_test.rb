...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { content: @newsletter.content, date: @newsletter.date, string: @newsletter.string, title: @newsletter.title }
    end
  ...
  test "should update newsletter" do
    put :update, id: @newsletter, newsletter: { content: @newsletter.content, date: @newsletter.date, string: @newsletter.string, title: @newsletter.title }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
